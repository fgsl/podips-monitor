 ...
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(response="200", description="verifica se o podips está lendo do Kubernetes")
 * )
 */
...
class KubernetesHandler implements RequestHandlerInterface
{
...
JSON;        
        ...
        $status = 'success';
        try {
            Monitor::getInstance()->setKubernetesReadingStatus($json);
        } catch (\Exception $e) {
            $status = $e->getMessage();
        } 
